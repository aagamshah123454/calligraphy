...
$(document).ready(function () {
    ...
    try{
document.querySelector("#variant").addEventListener('change',()=>
{
    let val = document.querySelector("#variant").value;
    for(let i=1;i<=4;i++)
    {
        document.querySelector(`.variant${i}x`).style.display="none";   
    }
    document.querySelector(`.${val}x`).style.display="block";
})
    }
    catch(err)
    {
